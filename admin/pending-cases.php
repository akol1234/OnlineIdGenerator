			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Pending cases</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">List pending cases</div>
...
<?php 
$reciver = 'Admin';
$sql = "SELECT * from  information where reciver = (:reciver) AND status = 0";
$query = $dbh -> prepare($sql);
...
{				?>	
										<tr>
											...
											<td>Pending <i class="fa fa-times-circle"></i></a></td> 	                     
										</tr>
										<?php $cnt=$cnt+1; }} ?>
