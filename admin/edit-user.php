	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">View User : <?php echo htmlentities($result->name); ?></h3>
						<div class="row">
							<div class="col-md-12">
...
<div class="col-sm-4">
<input type="text" name="name" class="form-control" readonly required value="<?php echo htmlentities($result->name);?>">
</div>
...
<div class="col-sm-4">
<input type="text" name="name" class="form-control" readonly required value="<?php echo htmlentities($result->gender);?>">
</div>
<label class="col-sm-2 control-label">Program<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="col-sm-4">
<input type="number" name="mobileno" class="form-control" readonly required value="<?php echo htmlentities($result->mobile);?>">
</div>
</div>

<div class="form-group">
	<div class="col-sm-8 col-sm-offset-2">
		<a href=""><img src="../images/<?php echo htmlentities($result->image);?>" width="150px"/></a>
